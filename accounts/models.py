...
class Employer(models.Model):
    ...
    company_specialization=models.CharField(max_length=200,choices=compchoice,default='Php')
...
class Pay(models.Model):
    ...
    plan_id=models.CharField(max_length=200,choices=subscription_choice,default='499 per month')
